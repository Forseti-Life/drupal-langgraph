  ...
  private function builtInFlows(): array {
    return [
      ...
      [
        'id' => 'agentic_sdlc',
        'label' => 'Agentic SDLC',
        'description' => 'Reference SDLC graph imported from the external LangGraph example, with design approval fanning out into parallel implementation and test-case authoring, an explicit readiness merge before QA, review or QA failures routing directly back to the originating authoring step, and product-team-owned BA/PM/Dev/QA stages resolved dynamically from the selected product team.',
